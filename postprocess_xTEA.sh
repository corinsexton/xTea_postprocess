...
./annotate_xtea.py /home/cos689/data1/corinne/ref/gencode/hg38_gencode_ann.gff3 ${results_dir}/../ALU_${dataset_prefix}_1kg.vcf ${results_dir}/../annotated_${dataset_prefix}_ALU.tsv
./annotate_xtea.py /home/cos689/data1/corinne/ref/gencode/hg38_gencode_ann.gff3 ${results_dir}/../L1_${dataset_prefix}_1kg.vcf ${results_dir}/../annotated_${dataset_prefix}_L1.tsv
